...
class Invoice_products_model extends Super_Model
{
    ...
    function getInvoiceProducts($id = '')
    {
    ...
    function addItem($id = '')
    {
        ...
        //_____SQL QUERY_______
        $query = $this->db->query("INSERT INTO invoice_products (
                                          invoice_products_invoice_id,
                                          invoice_products_project_id,
                                          invoice_products_title,
                                          invoice_products_description,
                                          invoice_products_quantity,
                                          invoice_products_rate,
                                          invoice_products_total
                                          )VALUES(
                                          $invoice_products_invoice_id,
                                          $invoice_products_project_id,
                                          $invoice_products_title,
    ...
    function deleteItems($invoice_id = '')
    {
