...
/**
 * class for perfoming all permissions related data abstraction
 *
 * @author   
 * @access   public
 * @see      
 */
class Permissions_model extends Super_Model
{
    ...
    // -- permissionsTable ----------------------------------------------------------------------------------------------
    /**
     * loads all the matrix rows from the permissions table
     *
     * @return	array
     */
