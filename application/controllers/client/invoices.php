...
class Invoices extends MY_Controller
{
    ...
    function __viewInvoices()
    {
        ...
        ** -----------------------------------------*/
        ...
        $this->data['blocks']['invoices'] = $this->invoices_model->searchInvoices($offset, 'search', $this->client_id, 'client');
        $this->data['debug'][] = $this->invoices_model->debug_data;

        //count results rows - used by pagination class
        $rows_count = $this->invoices_model->searchInvoices($offset, 'count', $this->client_id, 'client');
